...
If you find a security vulnerability in AntCAM, please report it through [GitHub's private vulnerability reporting](https://github.com/TheAntTeam/antcam/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact compact.pcb.maker.team@gmail.com for details.
